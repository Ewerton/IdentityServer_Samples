// https://github.com/DuendeSoftware/Samples/blob/main/IdentityServer/v6/Quickstarts/6_JS_with_backend/src/JavaScriptClient/wwwroot/app.js
...
let userClaims = null; // Tem que ser global pois vai ser acessada de qualquer lugar da aplicação
...
async function localApi() {
    var req = new Request("/LocalAPI/LocalIdentityHandler", {
        headers: new Headers({
            "X-CSRF": "1",
        }),
    });
